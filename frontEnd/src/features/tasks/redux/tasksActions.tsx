...
export const changeFilterAction: CaseReducer<
  tasksState,
  PayloadAction<filterType>
> = (state, action) => {
  return {
    ...state,
...
export const initEditTaskAction: CaseReducer<
  tasksState,
...
export const focusTaskAction: CaseReducer<tasksState, PayloadAction<number>> = (
  state,
  action
) => {
  return {
...
export const addTask: CaseReducer<
  tasksState,
  PayloadAction<taskTypeApiResult | undefined>
> = (state, action) => {
